        ...
        for module_data in modules_to_test:
            ...
            if os.path.isfile(to_test):
                ...
                if os.path.isdir('private'):
                    print('Private tests:')
                    run_tests(module_data['moduleName'], to_test, tests_root_dir, module_data['privateTests'], data["testDirNames"], float(data['defaultTimeout']), int(data['abbreviatedOutputLen']))
